...
async def main():
    ...
    # Ruta del SQL de la migración M11
    script_dir = Path(__file__).resolve().parent
    sql_path = script_dir.parent.parent / "_modelBD" / "M11_limpieza_enums.sql"
    ...
    try:
        ...
        print("Aplicando migración M11 (Limpieza de ENUMs obsoletos)...")
        await conn.execute(sql_content)
        print("Migración M11 aplicada exitosamente en NeonDB.")
