...
async def main():
    ...
    # Ruta del SQL de la migración M10
    script_dir = Path(__file__).resolve().parent
    sql_path = script_dir.parent.parent / "_modelBD" / "M10_vista_conciliacion.sql"
    ...
    try:
        ...
        print("Aplicando migración M10 (Vista de conciliación de inventario)...")
