...
async def main():
    ...
    # Ruta del SQL de la migración M12
    script_dir = Path(__file__).resolve().parent
    sql_path = script_dir.parent.parent / "_modelBD" / "M12_correcion_triggers_ventas.sql"
    ...
    try:
        ...
        print("Aplicando migración M12 (Casting de ENUM en triggers de ventas)...")
        await conn.execute(sql_content)
        print("Migración M12 aplicada exitosamente en NeonDB.")
